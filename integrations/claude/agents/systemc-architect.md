...
Use focused direct-UHDM Python scripts for structural and semantic questions.
Check the selected top/module and source location. Cite only source-located
RTL/spec evidence; raw UHDM script output is
